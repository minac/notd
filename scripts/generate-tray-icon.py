...
Produces two 44x44 PNGs derived from src-tauri/icons/icon.icns:
  ...
  - tray-light.png: black rounded square with the calligraphic
    glyph cut out as a transparent hole. Used on light menu bars.
  - tray-dark.png:  white rounded square, same transparent glyph
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        render(source, "black", ICONS / "tray-light.png")
        render(source, "white", ICONS / "tray-dark.png")
